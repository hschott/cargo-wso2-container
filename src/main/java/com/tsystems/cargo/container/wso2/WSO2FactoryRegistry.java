...
public class WSO2FactoryRegistry extends AbstractFactoryRegistry {
    ...
    protected void register(final ConfigurationCapabilityFactory factory) {
        ...
        factory.registerConfigurationCapability(WSO2Carbon4xContainer.ID, ContainerType.INSTALLED,
                ConfigurationType.EXISTING, WSO2ExistingLocalConfigurationCapability.class);
        factory.registerConfigurationCapability(WSO2Carbon4xContainer.ID, ContainerType.INSTALLED,
                ConfigurationType.STANDALONE, WSO2StandaloneLocalConfigurationCapability.class);
    }
    ...
    protected void register(final ConfigurationFactory factory) {
        factory.registerConfiguration(WSO2Carbon4xContainer.ID, ContainerType.REMOTE, ConfigurationType.RUNTIME,
                WSO2RuntimeConfiguration.class);
        factory.registerConfiguration(WSO2Carbon4xContainer.ID, ContainerType.INSTALLED, ConfigurationType.EXISTING,
                WSO2ExistingLocalConfiguration.class);
        factory.registerConfiguration(WSO2Carbon4xContainer.ID, ContainerType.INSTALLED, ConfigurationType.STANDALONE,
                WSO2StandaloneLocalConfiguration.class);
    }
    ...
    protected void register(final ContainerCapabilityFactory factory) {
        factory.registerContainerCapability(WSO2Carbon4xContainer.ID, WSO2ContainerCapability.class);
    }
    ...
    protected void register(final ContainerFactory factory) {
        factory.registerContainer(WSO2Carbon4xContainer.ID, ContainerType.REMOTE, WSO2Carbon4xRemoteContainer.class);
    ...
    protected void register(final DeployerFactory factory) {
        factory.registerDeployer(WSO2Carbon4xContainer.ID, DeployerType.REMOTE, WSO2Carbon4xRemoteDeployer.class);
