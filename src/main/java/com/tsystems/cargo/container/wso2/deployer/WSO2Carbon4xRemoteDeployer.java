...
public class WSO2Carbon4xRemoteDeployer extends AbstractWSO2RemoteDeployer {
    ...
    protected void createWso2AdminServices() {
        ...
        String wso2username = configuration
                .getPropertyValue(WSO2CarbonPropertySet.CARBON_USERNAME);
        String wso2password = configuration
                .getPropertyValue(WSO2CarbonPropertySet.CARBON_PASSWORD);

        String httpUsername = configuration
                .getPropertyValue(RemotePropertySet.USERNAME);
        String httpPassword = configuration
                .getPropertyValue(RemotePropertySet.PASSWORD);

        WSO2Axis2ModuleAdminService axis2ModuleAdminService = new WSO2Carbon4xAxis2ModuleAdminService(
                managerURL, wso2username, wso2password, httpUsername,
                httpPassword);
        axis2ModuleAdminService.setLogger(getLogger());
        setAxis2ModuleAdminService(axis2ModuleAdminService);

        WSO2Axis2ServiceAdminService axis2ServiceAdminService = new WSO2Carbon4xAxis2ServiceAdminService(
                managerURL, wso2username, wso2password, httpUsername,
                httpPassword);
        ...
        WSO2WarAdminService warAdminService = new WSO2Carbon4xWarAdminService(
                managerURL, wso2username, wso2password, httpUsername,
                httpPassword);
        ...
        WSO2BAMToolboxAdminService bamToolboxAdminService = new WSO2Carbon4xBAMToolboxAdminService(
                managerURL, wso2username, wso2password, httpUsername,
                httpPassword);
